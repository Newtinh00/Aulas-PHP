...
class Usuario{
	...
	public function login($login, $password){
		...
		$sql = new Sql();
		$results = $sql->select("SELECT * FROM tb_usuarios WHERE deslogin = :LOGIN AND desenha = :PASSWORD", array(":LOGIN"=>$login, ":PASSWORD"=>$password));
	...
	public function insert(){
		...
		$sql = new Sql();
		$results = $sql->select("SET NOCOUNT ON; EXEC sp_usuarios_insert :LOGIN, :PASSWORD", array(
